...
@Mod("ecolithica")
public class EcolithicaMod {
	public static final Logger LOGGER = LogManager.getLogger(EcolithicaMod.class);
	public static final String MODID = "ecolithica";

	public EcolithicaMod() {
